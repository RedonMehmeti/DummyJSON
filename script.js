...
for (let i = 0; i < jsonData.products.length; i++) {
    ...
    const products = jsonData.products[i];
    
    const row = tableBody.insertRow();


    row.insertCell(0).innerHTML = products.title;       
    row.insertCell(1).innerHTML = products.description;     
    row.insertCell(2).innerHTML = products.price;
